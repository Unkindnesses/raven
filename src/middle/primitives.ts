...
import { inlinePrimitives, InvokeSt, outlinePrimitives, inlinePrimitive, outlinePrimitive, primitive } from './prim_map.js'
...
function core() {
  ...
  for (const meth of primitives()) mod.methods.method(meth.key)
  return mod
}
